...
|---------|------|----------|
| Single-process | `src/main_working.cpp` | Compact runs and debugging |
...
│   ├── main_working.cpp       # Single-process DPI path
│   ├── dpi_mt.cpp             # Multi-threaded DPI path
│   └── [other files]          # Supporting code
│
├── generate_test_pcap.py      # Creates test data
├── test_dpi.pcap              # Test capture containing mixed traffic
└── README.md                  # This file!
```
...
# Creates test_dpi.pcap with generated traffic
```
...
If you have questions about any part of this project, start with `main_working.cpp` for a compact execution path, then move to `dpi_mt.cpp` for the parallel architecture.
